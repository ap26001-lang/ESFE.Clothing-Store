namespace ESFE.Clothing_Store.UI
{
    partial class Usuario
    {
        ...
        {
            tituloLblFrmUsuario = new Label();
            buscarLblFrmUsuario = new Label();
            idUsuarioLblFrmUsuario = new Label();
            usuarioLblFrmUsuario = new Label();
            buscarTxtFrmUsuario = new TextBox();
            idUsuarioTxtFrmUsuario = new TextBox();
            usuarioTxtFrmUsuario = new TextBox();
            buscarBtnFrmUsuario = new Button();
            guardarBtnFrmUsuario = new Button();
            eliminarBtnFrmUsuario = new Button();
            agregarBtnFrmUsuario = new Button();
            limpiarBtnFrmUsuario = new Button();
            SuspendLayout();
            // 
            // tituloLblFrmUsuario
            // 
            ...
            tituloLblFrmUsuario.TabIndex = 0;
            tituloLblFrmUsuario.Text = "Usuario";
            // 
            // buscarLblFrmUsuario
            // 
            ...
            idUsuarioLblFrmUsuario.TabIndex = 5;
            idUsuarioLblFrmUsuario.Text = "Id_usuario";
            // 
            ...
            usuarioLblFrmUsuario.TabIndex = 6;
            usuarioLblFrmUsuario.Text = "Usuario";
            // 
            // buscarTxtFrmUsuario
            // 
            ...
            buscarTxtFrmUsuario.TabIndex = 3;
            // 
            ...
            usuarioTxtFrmUsuario.TabIndex = 11;
            // 
            // buscarBtnFrmUsuario
            // 
            ...
            Controls.Add(limpiarBtnFrmUsuario);
            Controls.Add(agregarBtnFrmUsuario);
            Controls.Add(eliminarBtnFrmUsuario);
            Controls.Add(guardarBtnFrmUsuario);
            Controls.Add(buscarBtnFrmUsuario);
            Controls.Add(usuarioTxtFrmUsuario);
            Controls.Add(idUsuarioTxtFrmUsuario);
            Controls.Add(buscarTxtFrmUsuario);
            Controls.Add(usuarioLblFrmUsuario);
            Controls.Add(idUsuarioLblFrmUsuario);
            Controls.Add(buscarLblFrmUsuario);
            Controls.Add(tituloLblFrmUsuario);
            Name = "Usuario";
            Text = "Usuario";
            ResumeLayout(false);
            PerformLayout();
        ...
        private Label tituloLblFrmUsuario;
        private Label buscarLblFrmUsuario;
        private Label idUsuarioLblFrmUsuario;
        private Label usuarioLblFrmUsuario;
        private TextBox buscarTxtFrmUsuario;
        private TextBox idUsuarioTxtFrmUsuario;
        private TextBox usuarioTxtFrmUsuario;
        private Button buscarBtnFrmUsuario;
        private Button guardarBtnFrmUsuario;
        private Button eliminarBtnFrmUsuario;
        private Button agregarBtnFrmUsuario;
        private Button limpiarBtnFrmUsuario;
    }
}
